...
- (void)initSubviews {
    ...
    UITabBarItem *item3 = [QDUIHelper tabBarItemWithTitle:@"设置" image:[UIImageMake(@"icon_tabbar_lab") imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:UIImageMake(@"icon_tabbar_lab_selected") tag:2];
